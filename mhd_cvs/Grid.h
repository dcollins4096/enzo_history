...
/* Identify Multi-speciesi fields. */
 ...
 int DeleteBiermannTerms();  
  ...
  int MHD_LinearSlope(float * Lhs, float * Rhs, int * index, int dim
		      , int DifferenceOnly = FALSE);
  int MHD_Hancock1(float * Lhs, float * Rhs, int * index, int dim, float dT, float Bx );
  int MHD_Hancock2(float * Lhs, float * Rhs, int * index, int dim, float dT, float Bx );
