...
float grid::MHD_Diffusion(float * Fluxes, float * Lhs, float * Rhs, int * index, 
  ...
  case 1:
    nu = Lhs[Sv[0]] - Rhs[Sv[0] ]
      + ( (Transverse1 == 1 ) ? 
	  (dxI[Taxis1] * CellWidth[dim][0] * 0.25 * ( ( State[Sv[1]][ Y2 ] - State[ Sv[1] ][ Y1 ] )
						      +(State[Sv[1]][ Y4 ] - State[ Sv[1] ][ Y3 ] ) ) )
	  : 0 )
      + ( (Transverse2 == 1 ) ? 
	  (dxI[Taxis2] * CellWidth[dim][0] * 0.25 * ( ( State[Sv[2]][ Z2 ] - State[ Sv[2] ][ Z1 ] )
						      +(State[Sv[2]][ Z4 ] - State[ Sv[2] ][ Z3 ] ) ) )
	  : 0 );
  ...
  case 3:
    nu = State[ Sv[0] ][ index[1] ] - State[ Sv[0] ][ index[0] ]
      + ( (Transverse1 == 1 ) ? 
	  (dxI[Taxis1] * CellWidth[dim][0] * 0.25 * ( ( State[Sv[1]][ Y2 ] - State[ Sv[1] ][ Y1 ] )
						      +(State[Sv[1]][ Y4 ] - State[ Sv[1] ][ Y3 ] ) ) )
	  : 0 )
  ...
  case 5:
    nu = Lhs[Sv[0]] - Rhs[Sv[0] ]
      + ( (Transverse1 == 1 ) ? 
	  (dxI[Taxis1] * CellWidth[dim][0] * 0.5 * MinMod( ( State[Sv[1]][ Y2 ] - State[ Sv[1] ][ Y1 ] ),
							   (State[Sv[1]][ Y4 ] - State[ Sv[1] ][ Y3 ] ) ) )
	  : 0 )
      + ( (Transverse2 == 1 ) ? 
	  (dxI[Taxis2] * CellWidth[dim][0] * 0.5 * MinMod( ( State[Sv[2]][ Z2 ] - State[ Sv[2] ][ Z1 ] ),
							   (State[Sv[2]][ Z4 ] - State[ Sv[2] ][ Z3 ] ) ) )
	  : 0 );
  ...
  case 7:
    ...
    nu =
      // d(Vx)/dx 
      dxI[dim]*
      (4*(State[ Sv[0] ][ index[0] ]- State[ Sv[0] ][ index[1] ])
       +2*( ( State[ Sv[0] ][ Y1 ] + State[ Sv[0] ][ Y2 ] + State[ Sv[0] ][ Z1 ] + State[ Sv[0] ][ Z2 ])
	    -(State[ Sv[0] ][ Y3 ] + State[ Sv[0] ][ Y4 ] + State[ Sv[0] ][ Z3 ] + State[ Sv[0] ][ Z4 ]))
       +( ( State[ Sv[0] ][ D11 ] + State[ Sv[0] ][ D12 ] + State[ Sv[0] ][ D13 ] + State[ Sv[0] ][ D14 ])
	  -(State[ Sv[0] ][ D21 ] + State[ Sv[0] ][ D22 ] + State[ Sv[0] ][ D23 ] + State[ Sv[0] ][ D24 ]) )
       )
      // d(Vy)/dy

      +dxI[Taxis1]*
      (2*( State[ Sv[1] ][ Y1 ] - State[ Sv[1] ][ Y2 ] )
       +( State[ Sv[1] ][ D11 ] - State[ Sv[1] ][ D12 ] )
       +( State[ Sv[1] ][ D13 ] - State[ Sv[1] ][ D14 ] )
       +2*( State[ Sv[1] ][ Y3 ] - State[ Sv[1] ][ Y4 ] )
       +( State[ Sv[1] ][ D21 ] - State[ Sv[1] ][ D22 ] )
       +( State[ Sv[1] ][ D23 ] - State[ Sv[1] ][ D24 ] )
       )

      // d(Vz)/dz
      +dxI[Taxis2]*
      (2*( State[ Sv[2] ][ Z1 ] - State[ Sv[2] ][ Z2 ] )
       +( State[ Sv[2] ][ D11 ] - State[ Sv[2] ][ D13 ] )
       +( State[ Sv[2] ][ D12 ] - State[ Sv[2] ][ D14 ] )
       +2*( State[ Sv[2] ][ Z3 ] - State[ Sv[2] ][ Z4 ] )
       +( State[ Sv[2] ][ D21 ] - State[ Sv[2] ][ D23 ] )
       +( State[ Sv[2] ][ D22 ] - State[ Sv[2] ][ D24 ] )
       )
  ...
  if( nu > 0 ) 
    if( dT > CellWidth[dim][0]/(State[ Sden ][ index[0] ] * MHD_DiffusionParameter * 2 * nu ) )
      fprintf(stderr," visc: dt/that crap = %e > 1\n",
	      dT/(CellWidth[dim][0]/(State[ Sden ][ index[0] ] * MHD_DiffusionParameter * 2 * nu ) ) );
