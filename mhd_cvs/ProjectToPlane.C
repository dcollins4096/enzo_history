...
#ifdef HAOXU
  float *ProjectedField[NUMBER_OF_PROJECTED_FIELDS+8], TempCellWidth;
  int bfields = 0;
  if(MHD_Used) bfields = 8;
#else
...
#ifdef HAOXU
  for (field = 0; field < NUMBER_OF_PROJECTED_FIELDS+bfields; field++) {
#else
 ...
 if(MHD_Used){
  //Magnetic field in X direction
      ...
      assert( file_dsp_id != h5_error );
        ...
        dset_name = "MagneticField_C_1";
 
       for (j = 0; j < size; j++)
       float_temp[j] = float32(ProjectedField[NUMBER_OF_PROJECTED_FIELDS+0][j]);
        ...
        HDF5_WriteStringAttr(dset_id, "Label", "MagneticField_C_1", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Units", "Gauss", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Format", "e10.7", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Geometry", "none", log_fptr);
   ...
   //Magnetic field in Y direction
      ...
      assert( file_dsp_id != h5_error );
        ...
        dset_name = "MagneticField_C_2";

       for (j = 0; j < size; j++)
       float_temp[j] = float32(ProjectedField[NUMBER_OF_PROJECTED_FIELDS+1][j]);
        ...
        HDF5_WriteStringAttr(dset_id, "Label", "MagneticField_C_2", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Units", "Gauss", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Format", "e10.7", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Geometry", "none", log_fptr);
    ...
    //Magnetic field in Z direction
      ...
      assert( file_dsp_id != h5_error );
        ...
        dset_name = "MagneticField_C_3";

       for (j = 0; j < size; j++)
       float_temp[j] = float32(ProjectedField[NUMBER_OF_PROJECTED_FIELDS+2][j]);
        ...
        HDF5_WriteStringAttr(dset_id, "Label", "MagneticField_C_3", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Units", "Gauss", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Format", "e10.7", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Geometry", "none", log_fptr);
    ...
    h5_status = H5Dclose(dset_id);
     ...
     //Velocity field in X direction
      ...
      assert( file_dsp_id != h5_error );
        ...
        dset_name = "x-velocity";

       for (j = 0; j < size; j++)
       float_temp[j] = float32(ProjectedField[NUMBER_OF_PROJECTED_FIELDS+3][j]);
        ...
        HDF5_WriteStringAttr(dset_id, "Label", "x-velocity", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Units", "cm/s", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Format", "e10.7", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Geometry", "none", log_fptr);
    ...
    dset_name = "y-velocity";

       for (j = 0; j < size; j++)
       float_temp[j] = float32(ProjectedField[NUMBER_OF_PROJECTED_FIELDS+4][j]);
        ...
        HDF5_WriteStringAttr(dset_id, "Label", "y-velocity", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Units", "cm/s", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Format", "e10.7", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Geometry", "none", log_fptr);
    ...
    dset_name = "z-velocity";

       for (j = 0; j < size; j++)
       float_temp[j] = float32(ProjectedField[NUMBER_OF_PROJECTED_FIELDS+5][j]);
        ...
        HDF5_WriteStringAttr(dset_id, "Label", "z-velocity", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Units", "cm/s", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Format", "e10.7", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Geometry", "none", log_fptr);
    ...
    //Faraday rotation measurement RM
     ...
     dset_name = "RM";
       ...
       for (j = 0; j < size; j++)
       float_temp[j] = float32(ProjectedField[NUMBER_OF_PROJECTED_FIELDS+6][j]);
        ...
        HDF5_WriteStringAttr(dset_id, "Label", "RM", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Units", "cm/s", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Format", "e10.7", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Geometry", "none", log_fptr);
...
file_dsp_id);
     ...
     dset_name = "MED";
       ...
       for (j = 0; j < size; j++)
       float_temp[j] =
float32(ProjectedField[NUMBER_OF_PROJECTED_FIELDS+7][j]);

        if (io_log) fprintf(log_fptr, "H5Dcreate with Name = %s\n",
dset_name);

        dset_id = H5Dcreate(file_id, dset_name, file_type_id, file_dsp_id,
H5P_DEFAULT);
          if (io_log) fprintf(log_fptr, "H5Dcreate id: %d\n", dset_id);
          assert( dset_id != h5_error );

        HDF5_WriteStringAttr(dset_id, "Label", "MED", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Units", "erg", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Format", "e10.7", log_fptr);
        HDF5_WriteStringAttr(dset_id, "Geometry", "none", log_fptr);

     h5_status = H5Dwrite(dset_id, float_type_id, H5S_ALL, H5S_ALL,
H5P_DEFAULT, (VOIDP) float_temp);
      if (io_log) fprintf(log_fptr, "H5Dwrite: %d\n", h5_status);
      assert( h5_status != h5_error );
      JBPERF_COUNT_WRITE(dset_id, float_type_id, H5S_ALL);
