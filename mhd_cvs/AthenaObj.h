...
class AthenaObj{
 ...
 private:
  ...
  IndexPointerMap E, S; //Enzo and State.  I do hate one letter variable names, but I'm also lazy.
  ...
  //    so instead of Flux[0][ i+1,j,k ] - Flux[0][ i,j,k ], Flux[1][ i,j+1,k ] - Flux[1][ i,j,k ] 
