...
int grid::SetFlaggingField(int &NumberOfFlaggedCells, int level)
{
  ...
  /* beginning of Cell flagging criterion routine                        */
	...
	return FAIL;
      ...
      /* ==== METHOD 8: BY MHD (this sets hard coded zones.  Not useful.) ==== */
    case 8:
      fprintf(stderr, "========== Calling MHD Flag Cells =========\n");
      NumberOfFlaggedCells = this->FlagCellsToBeRefinedByMHD();

      if (NumberOfFlaggedCells < 0) {
	fprintf(stderr, "Error in grid->FlagCellsToBeRefinedByMHD.\n");
	return FAIL;
      }
    ...
    case 9:
      ...
      /* ==== METHOD 10: By Hand (Read Grid_FlagCellsToBeRefinedByHand for details ==== */
