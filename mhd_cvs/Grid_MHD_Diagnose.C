...
int grid::MHD_Diagnose(char * label)
{
  ...
  */
  ...
  //fprintf(stderr, " ++++           Total Energy  Diference     Kinetic        Magnetic      Gas\n");
  //fprintf(stderr, " ++++ Energies %13.6e %13.6e %13.6e %13.6e %13.6e \n", 
  //TotalEnergy, PreviousEnergy-TotalEnergy, Kinetic, MagneticCentered, GasEnergy);
  //  fprintf(eptr, " %13.12e %13.12e %13.12e %13.12e %13.12e \n", 
  //TotalEnergy,PreviousEnergy-TotalEnergy,  Kinetic, MagneticCentered, GasEnergy);  
  
  //fprintf(stderr, " ++++   Divergence for the grid %s \n", label);
