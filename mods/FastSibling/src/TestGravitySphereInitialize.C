				...
				HierarchyEntry &TopGrid, TopGridData &MetaData)
{
  ...
  while (fgets(line, MAX_LINE_LENGTH, fptr) != NULL) {
    ...
    ret += sscanf(line, "TestGravitySphereInteriorDensity = %f", 
		  &TestGravitySphereInteriorDensity);
    ret += sscanf(line, "TestGravitySphereExteriorDensity = %f", 
		  &TestGravitySphereExteriorDensity);
    ret += sscanf(line, "TestGravitySphereRadius = %f", 
		  &TestGravitySphereRadius);
    ret += sscanf(line, "TestGravitySphereType = %d", 
		  &TestGravitySphereType);
    ret += sscanf(line, "TestGravitySphereSubgridLeft = %"FSYM, 
		  &TestGravitySphereSubgridLeft);
    ret += sscanf(line, "TestGravitySphereSubgridRight = %"FSYM, 
		  &TestGravitySphereSubgridRight);
    ret += sscanf(line, "TestGravitySphereUseBaryons = %d",
		  &TestGravitySphereUseBaryons);
    ret += sscanf(line, "TestGravitySphereRefineAtStart = %d",
		  &TestGravitySphereRefineAtStart);
    ret += sscanf(line, "TestGravitySphereCenter = %"FSYM" %"FSYM" %"FSYM,
  ...
  if (MyProcessorNumber == ROOT_PROCESSOR) {
    fprintf(Outfptr, "TestGravitySphereInteriorDensity   = %f\n", 
	    TestGravitySphereInteriorDensity);
    fprintf(Outfptr, "TestGravitySphereExteriorDensity   = %f\n", 
	    TestGravitySphereExteriorDensity);
    fprintf(Outfptr, "TestGravitySphereRadius            = %f\n", 
	    TestGravitySphereRadius);
    fprintf(Outfptr, "TestGravitySphereType              = %d\n", 
	    TestGravitySphereType);
    fprintf(Outfptr, "TestGravitySphereSubgridLeft       = %"GOUTSYM"\n", 
	    TestGravitySphereSubgridLeft);
    fprintf(Outfptr, "TestGravitySphereSubgridRight      = %"GOUTSYM"\n", 
	    TestGravitySphereSubgridRight);
    fprintf(Outfptr, "TestGravitySphereUseBaryons        = %d\n",
	    TestGravitySphereUseBaryons);
    fprintf(Outfptr, "TestGravitySphereRefineAtStart     = %d\n",
	    TestGravitySphereRefineAtStart);
