...
int WriteParameterFile(FILE *fptr, TopGridData &MetaData)
{
  ...
  fprintf(fptr, "TracerParticleOn           = %d\n", TracerParticleOn);
  ...
  fprintf(fptr, "TracerParticleDumpNumber = %d\n", 
  ...
  fprintf(fptr, "MustRefineParticlesRefineToLevel = %d\n", 
	  MustRefineParticlesRefineToLevel);
  fprintf(fptr, "ParticleTypeInFile               = %d\n\n", 1); // always true
