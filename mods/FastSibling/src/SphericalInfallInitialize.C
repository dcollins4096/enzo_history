			      ...
			      HierarchyEntry &TopGrid, TopGridData &MetaData)
{
  ...
  while (fgets(line, MAX_LINE_LENGTH, fptr) != NULL) {
    ...
    ret += sscanf(line, "SphericalInfallInitialPerturbation = %f", 
		  &SphericalInfallInitialPerturbation);
    ret += sscanf(line, "SphericalInfallSubgridLeft = %"FSYM, 
		  &SphericalInfallSubgridLeft);
    ret += sscanf(line, "SphericalInfallOmegaBaryonNow = %f",
		  &SphericalInfallOmegaBaryonNow);
    ret += sscanf(line, "SphericalInfallOmegaCDMNow = %f",
		  &SphericalInfallOmegaCDMNow);
    ret += sscanf(line, "SphericalInfallSubgridRight = %"FSYM, 
    ...
    ret += sscanf(line, "SphericalInfallFixedMass = %f",
		  &SphericalInfallFixedMass);
    ret += sscanf(line, "SphericalInfallCenter = %"FSYM" %"FSYM" %"FSYM,
