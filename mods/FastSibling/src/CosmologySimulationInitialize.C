			       ...
			       HierarchyEntry &TopGrid, TopGridData &MetaData)
{
  ...
  while (fgets(line, MAX_LINE_LENGTH, fptr) != NULL) {
    ...
    ret += sscanf(line, "CosmologySimulationOmegaBaryonNow = %f", 
		  &CosmologySimulationOmegaBaryonNow);
    ret += sscanf(line, "CosmologySimulationOmegaCDMNow = %f", 
		  &CosmologySimulationOmegaCDMNow);
    ret += sscanf(line, "CosmologySimulationInitialTemperature = %f", 
    ...
    if (sscanf(line, "CosmologySimulationGridLeftEdge[%d]", &gridnum) > 0)
      ret += sscanf(line, "CosmologySimulationGridLeftEdge[%d] = %"FSYM" %"FSYM" %"FSYM,
    ...
    if (sscanf(line, "CosmologySimulationGridRightEdge[%d]", &gridnum) > 0)
      ret += sscanf(line, "CosmologySimulationGridRightEdge[%d] = %"FSYM" %"FSYM" %"FSYM,
    ...
    ret += sscanf(line, "CosmologySimulationInitialFractionHII = %f",
		  &CosmologySimulationInitialFractionHII);
    ret += sscanf(line, "CosmologySimulationInitialFractionHeII = %f",
		  &CosmologySimulationInitialFractionHeII);
    ret += sscanf(line, "CosmologySimulationInitialFractionHeIII = %f",
		  &CosmologySimulationInitialFractionHeIII);
    ret += sscanf(line, "CosmologySimulationInitialFractionHM = %f",
		  &CosmologySimulationInitialFractionHM);
    ret += sscanf(line, "CosmologySimulationInitialFractionH2I = %f",
		  &CosmologySimulationInitialFractionH2I);
    ret += sscanf(line, "CosmologySimulationInitialFractionH2II = %f",
  ...
  for (gridnum = 0; gridnum < CosmologySimulationNumberOfInitialGrids; 
	...
	sprintf(ParticleTypeName = new char[MAX_LINE_LENGTH], "%s.%1d", 
  ...
  if (MyProcessorNumber == ROOT_PROCESSOR) {
    ...
    if (CosmologySimulationGasEnergyName != NULL)
      fprintf(Outfptr, "CosmologySimulationGasEnergyName        = %s\n",
	      CosmologySimulationGasEnergyName);
    if (CosmologySimulationVelocityNames[0] != NULL) {
