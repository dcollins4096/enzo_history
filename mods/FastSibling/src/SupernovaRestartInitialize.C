			       ...
			       ExternalBoundary &Exterior)
{
  ...
  while (fgets(line, MAX_LINE_LENGTH, fptr) != NULL) {
    ...
    ret += sscanf(line, "SupernovaRestartEjectaMass = %f", 
		  &SupernovaRestartEjectaMass);
    ret += sscanf(line, "SupernovaRestartEjectaRadius = %f", 
		  &SupernovaRestartEjectaRadius);
    ret += sscanf(line, "SupernovaRestartEjectaEnergy = %f", 
		  &SupernovaRestartEjectaEnergy);
    ret += sscanf(line, "SupernovaRestartEjectaCenter = %"FSYM" %"FSYM" %"FSYM,
