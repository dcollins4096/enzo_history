			      ...
			      HierarchyEntry &TopGrid, TopGridData &MetaData)
{
  ...
  while (fgets(line, MAX_LINE_LENGTH, fptr) != NULL) {
    ...
    ret += sscanf(line, "PressurelessCollapseDirection = %d", 
		  &PressurelessCollapseDirection);
    ret += sscanf(line, "PressurelessCollapseInitialDensity = %f",
		  &PressurelessCollapseInitialDensity);
    ret += sscanf(line, "PressurelessCollapseNumberOfCells = %d", 
  ...
  if (MyProcessorNumber == ROOT_PROCESSOR) {
    fprintf(Outfptr, "PressurelessCollapseDirection      = %d\n",
	    PressurelessCollapseDirection);
    fprintf(Outfptr, "PressurelessCollapseInitialDensity = %f\n\n", 
	    PressurelessCollapseInitialDensity);
  }
