			       ...
			       int grid_id)
{
  ...
  if( MHD_Used == TRUE ){
    fprintf(stderr, "Write Grid Interpolate: This code is currently incorrect.  Fix it.\n");
    fprintf(stderr, "   The magnetic fields aren't properly treated.\n");
  ...
  if (coef2 != 1 && MyProcessorNumber == ProcessorNumber){
    ...
    if(MHD_Used){
      fprintf(stderr, "----------------------------------------\n");
      fprintf(stderr, "----------------------------------------\n");
      fprintf(stderr, "------ Warning: WriteGridInterpolate ---\n");
      fprintf(stderr, "---- Interpolated MagneticField not-----\n");
      fprintf(stderr, "------- debugged.  Take with a grain ---\n");
      fprintf(stderr, "----------- of salt, or debug it.-------\n");
      fprintf(stderr, "----------------------------------------\n");
      fprintf(stderr, "----------------------------------------\n");
      ...
      //Insert the appropriate Magnetic Field here.
