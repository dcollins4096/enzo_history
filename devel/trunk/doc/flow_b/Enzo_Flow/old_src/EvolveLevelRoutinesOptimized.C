...
//  fprintf(stderr, "PrepareDensityField: Enter DepositParticleMassField (Send)\n");
...
//  fprintf(stderr, "PrepareDensityField: Enter DepositParticleMassField (Receive)\n");
...
//  fprintf(stderr, "PrepareDensityField: P(%d): PGMF1 (send)\n", MyProcessorNumber);
...
//  fprintf(stderr, "PrepareDensityField: P(%d): PGMF2 (receive)\n", MyProcessorNumber);
...
//  fprintf(stderr, "PrepareDensityField: P(%d): COMF1 (send)\n", MyProcessorNumber);
...
//  fprintf(stderr, "PrepareDensityField: P(%d): COMF2 (receive)\n", MyProcessorNumber);
  ...
  if (level == 0) {
//  fprintf(stderr, "PrepareDensityField: P(%d): CPFLZero (send-receive)\n", MyProcessorNumber);
