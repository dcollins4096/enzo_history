...
//  fprintf(stderr, "----DPP: MyPN = %d, PN = %d, TGPN = %d, DIR (R=1,S=2) = %d, NP = %d\n",
...
//  fprintf(stderr, "----DPP Call CommSendParticles PN = %d, TGPN = %d, NP = %d\n",
...
//  fprintf(stderr, "----DPP Call TargetGrid->DepositPositions with NP = %d\n", NumberOfParticles);
