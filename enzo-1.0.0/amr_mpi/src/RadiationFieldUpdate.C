...
//      DataType = MPI_DOUBLE;
    ...
    JBPERF_START_MPI_REDUCE("MPI_Allreduce",size,DataType);
    CHECK_MPI_ERROR(MPI_Allreduce(buffer1, buffer, size, DataType, MPI_SUM, 
				  MPI_COMM_WORLD));
    JBPERF_STOP_MPI_REDUCE("MPI_Allreduce",size,DataType);
