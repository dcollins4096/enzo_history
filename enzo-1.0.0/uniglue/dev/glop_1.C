  ...
  for (kk = 0; kk < enzo_layout[2]; kk++)
    for (jj = 0; jj < enzo_layout[1]; jj++)
      ...
      // coordinate to rank check
        ...
        X_Left = (int)(GRID * Left[0] + eps);
        X_Right = (int)(GRID * Right[0] + eps) - 1;
        Y_Left = (int)(GRID * Left[1] + eps); 
        Y_Right = (int)(GRID * Right[1] + eps) - 1;
        Z_Left = (int)(GRID * Left[2] + eps); 
        Z_Right = (int)(GRID * Right[2] + eps) - 1;
...
*/
        ...
        fprintf(log,"Grid %d    [%d,%d]\n",gridcounter,X_Left,X_Right);
        fprintf(log,"Grid %d    [%d,%d]\n",gridcounter,Y_Left,Y_Right);
        fprintf(log,"Grid %d    [%d,%d]\n",gridcounter,Z_Left,Z_Right);
/*
        in_mem_offset = 0;
        in_mem_stride = 1;
