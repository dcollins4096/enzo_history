...
int ExternalBoundary::ReadExternalBoundary(FILE *fptr)
{
  ...
  if (NumberOfBaryonFields > 0) {
    ...
    // open HDF5 External Boundary file
	...
	//  Open HDF5 dataset for External Boundary types
	...
	//  Open HDF5 dataset for External Boundary values
        if (io_log) fprintf(log_fptr, "H5Dopen with Name = %s\n", dname2);
...
*/
	...
	for (field = 0; field < NumberOfBaryonFields; field++)
	  for (i = 0; i < 2; i++) {
	    ...
	    //  Independently read boundary types from parallel HDF5 file
