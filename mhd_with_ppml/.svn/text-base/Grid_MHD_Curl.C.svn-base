...
// Method 1: MagneticField -= Curl( ElectricField )
// Method 2: MagneticField = OldMagneticField - Curl( ElectricField )
//           Method 2 is what should be used in UpdateMagneticField and Athena MHD.
// 
  ...
  for(dimX=0;dimX<3; dimX++){
	...
	for(i=Start[0]; i<=End[0] + MHDAdd[0][dimX]; i++){
	  ...
	  case 1:
	    ...
	    break;
	  case 2:
	    fprintf(stderr,"ERROR: curl 2 not implemented\n");
	    return FAIL;
	    /*
