			  ...
			  HierarchyEntry &TopGrid, TopGridData &MetaData)
{
  ...
  float CollapseTestMagneticFieldx = 0.0;
  float CollapseTestMagneticFieldy = 0.0;
  float CollapseTestMagneticFieldz = 0.0;
#endif //PPML
  ...
  while (fgets(line, MAX_LINE_LENGTH, fptr) != NULL) {
    ...
    ret += sscanf(line, "CollapseTestMagneticFieldx = %"FSYM,
		  &CollapseTestMagneticFieldx);
    ret += sscanf(line, "CollapseTestMagneticFieldy = %"FSYM,
		  &CollapseTestMagneticFieldy);
    ret += sscanf(line, "CollapseTestMagneticFieldz = %"FSYM,
		  &CollapseTestMagneticFieldz);
#endif //PPML
  ...
  if( MHD_Used == TRUE ){
    ...
    //<dbg>
    fprintf(stderr,"Turkey Head: %d %s\n", count, BZName);
    //</dbg>
  } 
#endif //PPML
  for (i = 0; i < count; i++)
