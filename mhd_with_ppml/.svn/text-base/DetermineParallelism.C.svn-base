...
#ifndef USE_MPI
  SetProcessorLayout(0,1);
  SetProcessorLayout(1,1);
  SetProcessorLayout(2,1);
  SetProcessorLocation(0,0);
  SetProcessorLocation(1,0);
  SetProcessorLocation(2,0);
  SetProcessorNeighbors(0,0,0);
  SetProcessorNeighbors(0,1,0);
  SetProcessorNeighbors(1,0,0);
  SetProcessorNeighbors(1,1,0);
  SetProcessorNeighbors(2,0,0);
  SetProcessorNeighbors(2,1,0);
...
//   printf("proc %"ISYM", xProcMeshes = (%"FSYM",%"FSYM",%"FSYM")\n",MyProcessorNumber,X0ProcMesh[0],X1ProcMesh[0],X2ProcMesh[0]);
...
//     printf("process %"ISYM", bounds = (%"FSYM",%"FSYM")x(%"FSYM",%"FSYM")x(%"FSYM",%"FSYM")\n",ThatProc,x0Left,x0Right,x1Left,x1Right,x2Left,x2Right);
...
//   printf("proc %"ISYM": x0procs = %"ISYM",  X0ProcMesh = (%"FSYM",%"FSYM",%"FSYM",%"FSYM")\n",MyProcessorNumber,x0procs,X0ProcMesh[0],X0ProcMesh[1],X0ProcMesh[2],X0ProcMesh[3]);
//   printf("proc %"ISYM": x1procs = %"ISYM",  X1ProcMesh = (%"FSYM",%"FSYM",%"FSYM",%"FSYM")\n",MyProcessorNumber,x1procs,X1ProcMesh[0],X1ProcMesh[1],X1ProcMesh[2],X1ProcMesh[3]);
//   printf("proc %"ISYM": x2procs = %"ISYM",  X2ProcMesh = (%"FSYM",%"FSYM",%"FSYM",%"FSYM")\n",MyProcessorNumber,x2procs,X2ProcMesh[0],X2ProcMesh[1],X2ProcMesh[2],X2ProcMesh[3]);
...
//   printf("proc %"ISYM": x0LeftEdge = %"FSYM", x0Location = %"ISYM"\n",MyProcessorNumber,MyLeftEdge[0],location);
...
//   printf("proc %"ISYM": x1LeftEdge = %"FSYM", x1Location = %"ISYM"\n",MyProcessorNumber,MyLeftEdge[1],location);
...
//   printf("proc %"ISYM": x2LeftEdge = %"FSYM", x2Location = %"ISYM"\n",MyProcessorNumber,MyLeftEdge[2],location);
...
//   printf("Parallelism info., proc %"ISYM": layout = (%"ISYM",%"ISYM",%"ISYM"), location = (%"ISYM",%"ISYM",%"ISYM"), neighbors=([%"ISYM",%"ISYM"]x[%"ISYM",%"ISYM"]x[%"ISYM",%"ISYM"])\n",
// 	 MyProcessorNumber,
// 	 ThisGrid->GridData->GetProcessorLayout(0),
// 	 ThisGrid->GridData->GetProcessorLayout(1),
// 	 ThisGrid->GridData->GetProcessorLayout(2),
// 	 ThisGrid->GridData->GetProcessorLocation(0),
// 	 ThisGrid->GridData->GetProcessorLocation(1),
// 	 ThisGrid->GridData->GetProcessorLocation(2),
// 	 ThisGrid->GridData->GetProcessorNeighbors(0,0),
// 	 ThisGrid->GridData->GetProcessorNeighbors(0,1),
// 	 ThisGrid->GridData->GetProcessorNeighbors(1,0),
// 	 ThisGrid->GridData->GetProcessorNeighbors(1,1),
// 	 ThisGrid->GridData->GetProcessorNeighbors(2,0),
// 	 ThisGrid->GridData->GetProcessorNeighbors(2,1));
