...
// This routine reads only data from Inits: inits_type is 32- or 64-bit
...
#ifdef PPML
    //Improving error messages makes all programmers happy.
    fprintf(stderr, "Npart (%"ISYM") and Component_Rank (%"ISYM")do not agree!\n",
  ...
  for ( dim=0; dim < Rank; dim++)
  {
    // Reverted indices "Rank-dim-1" to "dim" to fix BUG-003 [JOB v1_1_7]
