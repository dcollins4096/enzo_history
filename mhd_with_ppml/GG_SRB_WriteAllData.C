...
#endif
{
  ...
  // Note: modified 24 May 2006 to fix interpolated data outputs [BWO v1_1_6]
...
//  strcat(gridbasename, GridSuffix);
  ...
  if (WriteDataHierarchy(fptr, MetaData, TempTopGrid, gridbasename, 
			 GridID, WriteTime) == FAIL) {
