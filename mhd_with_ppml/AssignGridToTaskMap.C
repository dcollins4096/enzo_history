...
*/
  ...
  grid_size = new double[MAX_TASKS];
  grid = new int[MAX_TASKS];
  task_node = new int[MAX_TASKS];
  task = new int[MAX_TASKS];

  freemem = new double[MAX_NODES];
  freecpu = new int[MAX_NODES];
  actual_node = new int[MAX_NODES];
  node_input = new int[MAX_NODES];
  tasks_per_node = new int[MAX_NODES];
  nodemem = new double[MAX_NODES];
