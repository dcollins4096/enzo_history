...
#ifdef PPML
//ATH || PPML
#define NUMBER_OF_INTEGRATION_STEPS         2 

#define DCC_EXTERNAL_CYCLE_COUNT
#define OR_MHD || MHD_Used == TRUE 
#define N_MidWayDumps   10 
#else //PPML
#define OR_MHD 
#endif //PPML

//Things that should be in the trunk.
#define SHOULD_BE
...
#define MAX_NUMBER_OF_BARYON_FIELDS        72  /* must be at least 6 */
...
#define MAX_NUMBER_RANDOM_FORCING          21
