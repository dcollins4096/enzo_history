...
int GenerateRealization(parmstruct *Parameters, parmstruct *SubGridParameters)
{
  ...
  if (Parameters->InitializeParticles) {
    ...
    printf("Start InitializeParticles\n\n\n");
    ...
    fprintf(stderr, "Allocate %lld bytes for ParticleField\n", big);
#endif
 
//    mm_p1 = (char *) sbrk(0);
//    mm_delta = mm_p1-mm_p0;
//    fprintf(stderr, "Mem before new ParticleField %Ld\n", mm_delta);
...
//    mm_p1 = (char *) sbrk(0);
//    mm_delta = mm_p1-mm_p0;
//    fprintf(stderr, "Mem after new ParticleField %Ld\n", mm_delta);
	...
	ParticleField[i] *= Temp;
      ...
      {
        big = ((long_int) (size) * (long_int) (sizeof(FLOAT)));
        fprintf(stderr, "Allocate %lld bytes for SubGrid TempField\n", big);
      }
#endif
 
//    mm_p1 = (char *) sbrk(0);
//    mm_delta = mm_p1-mm_p0;
//    fprintf(stderr, "Mem before WriteField1 %Ld\n", mm_delta);
...
//    mm_p1 = (char *) sbrk(0);
//    mm_delta = mm_p1-mm_p0;
//    fprintf(stderr, "Mem after WriteField1 %Ld\n", mm_delta);
...
//			  Parameters->GridRefinement       ) ? 0.5 : 0.0;
	...
	for (j = 0; j < Parameters->ParticleDims[1]; j++) {
      ...
      {
        big = ((long_int) (size) * (long_int) (sizeof(FLOAT)));
        fprintf(stderr, "Allocate %lld bytes for SubGrid TempField2\n", big);
      }
#endif
 
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem before WriteField2 %Ld\n", mm_delta);
    ...
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem after WriteField2 %Ld\n", mm_delta);
    ...
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem before WriteField3 %Ld\n", mm_delta);
    ...
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem after WriteField3 %Ld\n", mm_delta);
    ...
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem before delete ParticleField %Ld\n", mm_delta);
 
    delete [] ParticleField;
 
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem after delete ParticleField %Ld\n", mm_delta);
 
    fprintf(stderr, "Delete ParticleField\n");
...
//        ParticleTypeField[i] = PARTICLE_TYPE_TRACER;
  ...
  fprintf(stderr, "End InitializeParticles\n\n\n");
  ...
  if (Parameters->InitializeGrids) {
...
#ifdef RH_M
    big = ((long_int) (size) * (long_int) (sizeof(FLOAT)));
    fprintf(stderr, "Allocate %lld bytes for GridField\n", big);
#endif
    ...
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem before WriteField4 %Ld\n", mm_delta);
    ...
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem after WriteField4 %Ld\n", mm_delta);
    ...
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem before WriteField5 %Ld\n", mm_delta);
    ...
    mm_p1 = (char *) sbrk(0);
    mm_delta = mm_p1-mm_p0;
    fprintf(stderr, "Mem after WriteField5 %Ld\n", mm_delta);
    ...
    fprintf(stderr, "Delete GridField\n");
 
    fprintf(stderr, "End InitializeGrid\n\n\n");
