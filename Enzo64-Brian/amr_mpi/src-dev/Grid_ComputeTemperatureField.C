...
int grid::ComputeTemperatureField(float *temperature)
{
  ...
  float DensityUnits=1, LengthUnits=1, VelocityUnits=1, MassUnits=1, TimeUnits=1;
 
  /* Find the temperature units (no longer just for comoving coordinates) */
