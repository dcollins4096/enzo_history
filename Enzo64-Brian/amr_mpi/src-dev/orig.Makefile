...
#AMR_OPT := -D SIB1 -D SIB2 -D SIB3 -D SIB4 -D NO_FLUX_FIX -D NO_SAB -D NO_DC_OPT_SIBSUB -D JB_OPT_FAST_NEIGHBOR_SEARCH
...
.C.o:
	${CCxx} ${CCxxFLAGS} ${CCxx_OPT} ${AMR_OPT} ${OOC_OPT} -D${ENZO_INT} -D${INIT_PPR} -D${ENZO_PPR} -D${ENZO_XPR} -D${ENZO_END} -D${UNIGRID} -D ${TRACEFLAG} ${DEBUG} ${OPTS} $*.C
.c.o:
