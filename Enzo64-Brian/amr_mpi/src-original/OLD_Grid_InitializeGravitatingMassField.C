...
//  fprintf(stderr, "IGMF %"ISYM" :: %"ISYM" %"ISYM" %"ISYM"\n", RefinementFactor, GravitatingMassFieldDimension[0], GravitatingMassFieldDimension[1], GravitatingMassFieldDimension[2]);
