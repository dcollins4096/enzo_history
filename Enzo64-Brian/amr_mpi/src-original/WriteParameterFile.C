...
int WriteParameterFile(FILE *fptr, TopGridData &MetaData)
{
  ...
  fprintf(fptr, "MinimumOverDensityForRefinement = %"GSYM" %"GSYM" %"GSYM" %"GSYM" %"GSYM"\n",
  ...
  fprintf(fptr, "MinimumMassForRefinement = %.9"GSYM" %.9"GSYM" %.9"GSYM" %.9"GSYM" %.9"GSYM"\n",
  ...
  fprintf(fptr, "MinimumMassForRefinementLevelExponent = %"FSYM" %"FSYM" %"FSYM" %"FSYM" %"FSYM"\n",
