...
; read that grid
      thisGrid = grid_info[this_grid].num
      read_grid,thisGrid,grid_info[this_grid].baryon_file,tempx,$
        byname='x-velocity'
      read_grid,thisGrid,grid_info[this_grid].baryon_file,tempy,$
        byname='y-velocity'
      read_grid,thisGrid,grid_info[this_grid].baryon_file,tempz,$
        byname='z-velocity'
...
;      print,'i_r=',i_r
      ...
      if ((min(i_r-i_l) ge 1)  ) then begin
          case 1 of
              angular: begin
                  thisGrid = u_g[i].num
                  read_grid, thisGrid, u_g[i].baryon_file,tempx,$
                    byname='x-velocity'
                  read_grid, thisGrid, u_g[i].baryon_file,tempy,$
                    byname='y-velocity'
                  read_grid, thisGrid, u_g[i].baryon_file,tempz,$
                    byname='z-velocity'
              ...
              (entropy or pressure): begin 
                  thisGrid = u_g[i].num
                  read_grid, thisGrid,u_g[i].baryon_file,tempD,$
                    byname='Density'
                  read_grid, thisGrid,u_g[i].baryon_file,tempT,$
                    byname='Temperature'
...
;                  print,'reading '+dataset_name
                  thisGrid = u_g[i].num
                  read_grid, thisGrid,u_g[i].baryon_file,temp,$
                    byname=dataset_name
